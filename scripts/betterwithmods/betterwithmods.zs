...
//Turntable.add(<betterwithmods:unfired_pottery:1>, <contenttweaker:pot_unfired>, [<minecraft:clay_ball>]); // Find replacement 
...
//Horse Upgrades
//Cauldron.addUnstoked([<biomesoplenty:berries>*32,<primitivemobs:camouflage_dye>],[<cyclicmagic:horse_upgrade_variant>]); //find replacement for camo dye
